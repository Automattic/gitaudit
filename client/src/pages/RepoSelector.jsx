...
function RepoSelector() {
  ...
  useEffect(() => {
    // Filter repos based on search term (only search in full name)
    if (searchTerm) {
  ...
  function handleRepoAdded() {
    fetchRepositories(); // Refresh list after adding
      ...
      >
        ...
        {loading ? (
          <div style={{ textAlign: 'center', padding: '3rem' }}>
            <Spinner />
            <p style={{ marginTop: '1rem', color: '#666' }}>Loading repositories...</p>
          </div>
